import { IFactoryService } from '@yohira/extensions.dependency-injection.specification.tests/fakes/IFactoryService';
import { IFakeService } from '@yohira/extensions.dependency-injection.specification.tests/fakes/IFakeService';
