	...
	implements IAuthenticatedEncryptor, IDisposable
{
	...
	constructor(
		...
		this.symmetricAlgorithmBlockSizeInBytes = using(
			symmetricAlgorithmFactory(),
			(symmetricAlgorithm) => getBlockSizeInBytes(symmetricAlgorithm),
		);
		this.symmetricAlgorithmSubkeyLengthInBytes =
		...
		this.validationAlgorithmDigestLengthInBytes = using(
			validationAlgorithmFactory(),
			(validationAlgorithm) => getDigestSizeInBytes(validationAlgorithm),
		);
		this.validationAlgorithmSubkeyLengthInBytes =
