...
export const logStarting = (logger: ILoggerT<Host>): void => {
...
export const logStarted = (logger: ILoggerT<Host>): void => {
	if (logger.isEnabled(LogLevel.Debug)) {
...
export const logStopping = (logger: ILoggerT<Host>): void => {
	if (logger.isEnabled(LogLevel.Debug)) {
...
export const logStopped = (logger: ILoggerT<Host>): void => {
	if (logger.isEnabled(LogLevel.Debug)) {
