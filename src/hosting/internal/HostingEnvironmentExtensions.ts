import { NullFileProvider } from '@/file-providers/NullFileProvider';
import { PhysicalFileProvider } from '@/file-providers/PhysicalFileProvider';
import { IWebHostEnv } from '@/hosting.abstractions/IWebHostEnv';
import { WebHostOptions } from '@/hosting/internal/WebHostOptions';
